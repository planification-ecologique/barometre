...
(function () {
  ...
  var Collapse = /*@__PURE__*/(function (Disclosure) {
    ...
    var prototypeAccessors = { method: { configurable: true } };
    var staticAccessors = { instanceClassName: { configurable: true } };
    ...
    Collapse.prototype.adjustMargin = function adjustMargin () {
    ...
    Collapse.prototype.adjustWidth = function adjustWidth () {
    ...
    Collapse.prototype.adjustHeight = function adjustHeight () {
    ...
    prototypeAccessors.method.set = function (value) {
    ...
    Collapse.prototype.mutate = function mutate (attributesNames) {
