...
<div class="fr-card fr-card--no-icon fr-card--shadow adjust-height ">
    <div class="titleBox">
              <!-- <a href="#" class="fr-tag" target="_self">Emission</a> -->
        ...
        <div class="subtitle">
             <p class="fr-text--xs fr-text-mention--black">Objectif 2030</p>
        <div class="co2" >
            <p class="fr-badge fr-badge--green-emeraude fr-badge--sm">271</p>
        <p class="fr-text--xs">Millions de tonnes en équivalent CO2</p>
        </div>
        </div>
   ...
   <div class="cardFooter">
      <a href="#" class="fr-tag" target="_self">Atténuation</a>
      <div>
        <svg
          width="34"
          height="32"
        ...
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M10 20.6662H22V21.9995H10V20.6662ZM16.6667 16.7808L20.714 12.7328L21.6567 13.6755L16 19.3328L10.3433 13.6762L11.286 12.7328L15.3333 16.7795V9.33282H16.6667V16.7808Z"
            fill="#000091"
          />
          <rect x="0.5" y="0.499512" width="31" height="31" stroke="#DDDDDD" />
        </svg>
